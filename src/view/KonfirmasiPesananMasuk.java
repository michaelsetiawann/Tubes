 ...
 * @author William
 */
public class KonfirmasiPesananMasuk extends JFrame implements ActionListener {
    ...
    private void lihatKeranjang() {
        JFrame frame = new JFrame("Konfirmasi Masuk Pesanan");
